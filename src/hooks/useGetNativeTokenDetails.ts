...
export const useGetNativeTokenDetails = () => {
  ...
  const description = isSovereign
    ...
    : `The ${BRAND_NAME} REWA (${egldLabel}) Token is native to the ${BRAND_NAME} Network and will be used for everything from staking, governance, transactions, smart contracts and validator rewards.`;
