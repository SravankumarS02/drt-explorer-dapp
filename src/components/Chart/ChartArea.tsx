        ...
        <AreaChart data={chartData}>
          ...
          <defs>
            <linearGradient id='defaultGradient' x1='0' y1='0' x2='0' y2='1'>
              <stop offset='5%' stopColor={seriesConfig.stroke ?? primary} stopOpacity={0.15} />
              <stop offset='95%' stopColor={seriesConfig.stroke ?? primary} stopOpacity={0} />
            </linearGradient>
          </defs>
          {!isNaN(off) && (
            <defs>
          ...
          <Area
            ...
            activeDot={
              hasDot
                ? {
                    stroke: seriesConfig.stroke ?? primary,
                    fill: seriesConfig.stroke ?? primary
                  }
                : false
            }
          />
            ...
            <Tooltip
              content={(props) => (
                <ChartTooltip
                  ...
                  color={seriesConfig.stroke ?? primary}
                />
              )}
              cursor={
                hasCursor
